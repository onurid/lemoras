...
namespace Lemoras.Remora.Admin.Business
{
    public class UserService : BaseUserService, IUserService
    {
        ...
        public override IEnumerable GetUserRole()
        {
            ...
            //var userList = repo.GetAll<User>().ToList();
            //var userRoleList = repo.GetAll<UserRole>().ToList();
            //var appInsList = repoApp.GetAll<ApplicationInstance>().ToList();
            //var appList = repoApp.GetAll<Application>().ToList();
            //var roleList = repoRole.GetAll<Role>().ToList();
